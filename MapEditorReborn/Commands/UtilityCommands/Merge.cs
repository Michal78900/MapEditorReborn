...
public class Merge : ICommand
{
    ...
    {
        get => "Merges two or more maps into one.";
    }
    ...
    public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
    {
        ...
        {
            var map = MapUtils.GetMapByName(arguments.At(i));
        ...
        File.WriteAllText(Path.Combine(MapEditorReborn.MapsDir, $"{outputMap.Name}.yml"), MapEditorReborn.Serializer.Serialize(outputMap));
