...
public class Properties : ICommand
{
    ...
    {
        get => "Allows modifying properties of the selected map.";
    }
    ...
    public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
    {
        ...
        var variableName = arguments.At(0).ToLower();
        ...
        {
            if (arguments.Count < 2 || !bool.TryParse(arguments.ElementAt(1), out var newValue))
            {
        ...
        if ("ragdollrolenames".Contains(variableName))
        {
            ...
            var nickname = arguments.At(2);
            for (var i = 1; i < arguments.Count - 2; i++)
            {
