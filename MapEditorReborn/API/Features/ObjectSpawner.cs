...
public static class ObjectSpawner
{
    ...
    {
        var forcedPosition = ParseArgument<Vector3?>(1, args);
        Quaternion? forcedRotation = ParseArgument<Quaternion>(2, args);
        var forcedScale = ParseArgument<Vector3?>(3, args);
        ...
        switch (typeof(T).Name)
        {
            case nameof(SchematicObject):
            {
                ...
                var data = ParseArgument<SchematicObjectDataList>(4, args);
    ...
    public static DoorObject SpawnDoor(DoorSerializable door, Vector3? forcedPosition = null, Quaternion? forcedRotation = null, Vector3? forcedScale = null)
    {
        ...
        var gameObject = Object.Instantiate(door.DoorType.GetDoorObjectByType(), forcedPosition ?? GetRelativePosition(door.Position, room), forcedRotation ?? GetRelativeRotation(door.Rotation, room));
    ...
    public static WorkstationObject SpawnWorkstation(WorkstationSerializable workStation, Vector3? forcedPosition = null, Quaternion? forcedRotation = null, Vector3? forcedScale = null)
    {
        ...
        var gameObject = Object.Instantiate(ObjectType.WorkStation.GetObjectByMode(), forcedPosition ?? GetRelativePosition(workStation.Position, room), forcedRotation ?? GetRelativeRotation(workStation.Rotation, room));
    ...
    public static ItemSpawnPointObject SpawnItemSpawnPoint(ItemSpawnPointSerializable itemSpawnPoint, Vector3? forcedPosition = null, Quaternion? forcedRotation = null, Vector3? forcedScale = null)
    {
        ...
        var gameObject = Object.Instantiate(ObjectType.ItemSpawnPoint.GetObjectByMode(), forcedPosition ?? GetRelativePosition(itemSpawnPoint.Position, room), forcedRotation ?? GetRelativeRotation(itemSpawnPoint.Rotation, room));
    ...
    public static PlayerSpawnPointObject SpawnPlayerSpawnPoint(PlayerSpawnPointSerializable playerSpawnPoint, Vector3? forcedPosition = null)
    {
        ...
        var gameObject = Object.Instantiate(ObjectType.PlayerSpawnPoint.GetObjectByMode(), forcedPosition ?? GetRelativePosition(playerSpawnPoint.Position, room), Quaternion.identity);
    ...
    public static RagdollSpawnPointObject SpawnRagdollSpawnPoint(RagdollSpawnPointSerializable ragdollSpawnPoint, Vector3? forcedPosition = null, Quaternion? forcedRotation = null)
    {
        ...
        var gameObject = Object.Instantiate(ObjectType.RagdollSpawnPoint.GetObjectByMode(), forcedPosition ?? GetRelativePosition(ragdollSpawnPoint.Position, room), forcedRotation ?? GetRelativeRotation(ragdollSpawnPoint.Rotation, room));
    ...
    public static PrimitiveObject SpawnPrimitive(PrimitiveSerializable primitiveObject, Vector3? forcedPosition = null, Quaternion? forcedRotation = null, Vector3? forcedScale = null)
    {
        ...
        var gameObject = Object.Instantiate(ObjectType.Primitive.GetObjectByMode(), forcedPosition ?? GetRelativePosition(primitiveObject.Position, room), forcedRotation ?? GetRelativeRotation(primitiveObject.Rotation, room));
    ...
    public static LightSourceObject SpawnLightSource(LightSourceSerializable lightSourceObject, Vector3? forcedPosition = null)
    {
        ...
        var gameObject = Object.Instantiate(ObjectType.LightSource.GetObjectByMode(), forcedPosition ?? GetRelativePosition(lightSourceObject.Position, room), Quaternion.identity);
    ...
    public static TeleportObject SpawnTeleport(SerializableTeleport teleport)
    {
        ...
        var gameObject = Object.Instantiate(ObjectType.Teleporter.GetObjectByMode(), GetRelativePosition(teleport.Position, room), Quaternion.identity);
    ...
    public static LockerObject SpawnLocker(LockerSerializable locker, Vector3? forcedPosition = null, Quaternion? forcedRotation = null, Vector3? forcedScale = null)
    {
        ...
        var gameObject = Object.Instantiate(locker.LockerType.GetLockerObjectByType(), forcedPosition ?? GetRelativePosition(locker.Position, room), forcedRotation ?? GetRelativeRotation(locker.Rotation, room));
    ...
    public static SchematicObject SpawnSchematic(SchematicSerializable schematicObject, Vector3? forcedPosition = null, Quaternion? forcedRotation = null, Vector3? forcedScale = null, SchematicObjectDataList data = null)
    {
        ...
        var schematicObjectComponent = gameObject.AddComponent<SchematicObject>().Init(schematicObject, data);
    ...
    private static T ParseArgument<T>(int index, object[] args) => args.TryGet(index, out var elem) && elem is T outer ? outer : default;
}