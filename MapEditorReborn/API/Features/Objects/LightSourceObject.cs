...
using Light = Exiled.Features.Toys.Light;
...
public class LightSourceObject : MapEditorObject
{
    ...
    public LightSourceObject Init(LightSourceSerializable lightSourceSerializable, bool spawn = true)
    {
        ...
        ForcedRoomType = lightSourceSerializable.RoomType != Exiled.Enums.RoomType.Unknown ? lightSourceSerializable.RoomType : FindRoom().Type;
        UpdateObject();
