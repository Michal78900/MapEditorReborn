...
public class Scp244 : Usable, IWrapper<Scp244Item>
{
    ...
    internal Scp244(ItemType scp244Type)
        : this((Scp244Item)PluginAPI.Core.Server.Instance.ReferenceHub.inventory.CreateItemInstance(new(scp244Type, 0), false))
    {
    }
    ...
    {
        var pickup = (Scp244Pickup)Pickup.Get(Object.Instantiate(Base.PickupDropModel, position, rotation));
