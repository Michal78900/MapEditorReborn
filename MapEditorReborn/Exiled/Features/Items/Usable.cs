...
public class Usable : Item, IWrapper<UsableItem>
{
    ...
    internal Usable(ItemType type)
        : this((UsableItem)PluginAPI.Core.Server.Instance.ReferenceHub.inventory.CreateItemInstance(new(type, 0), false))
    {
    }
    ...
    /// </summary>
    public float PlayerGetCooldown
    {
        get => UsableItemsController.GetCooldown(Serial, Base, UsableItemsController.GetHandler(Base.Owner));
    }
