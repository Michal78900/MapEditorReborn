...
internal class ToolGunHandler
{
    ...
    {
        var gameObject = Object.Instantiate(mode.GetObjectByMode(), position, Quaternion.identity);
        gameObject.transform.rotation = GetRelativeRotation(Vector3.zero, Exiled.Features.Map.FindParentRoom(gameObject));
    ...
    internal static bool TryGetMapObject(Player player, out MapEditorObject mapObject)
    {
        ...
        // if (Physics.Raycast(player.CameraTransform.position + forward, forward, out var hit, 100f))
        // {
        ...
        //     }
        //
        //     foreach (var pos in RoomLightObject.FlickerableLightsPositions)
        //     {
        //         var sqrDistance = (pos - hit.point).sqrMagnitude;
        //
        //         if (sqrDistance <= 2.5f)
        //         {
