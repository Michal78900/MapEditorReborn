...
public class SelectingObjectEventArgs : EventArgs
{
    ...
    public SelectingObjectEventArgs(MERPlayer player, MapEditorObject mapEditorObject, bool isAllowed = true)
    {
        Player = player;
    ...
    /// <summary>
    /// Gets the <see cref="PluginAPI.Core.Player"/> who's selecting the <see cref="MapEditorObject"/>.
    /// </summary>
    ...
    {
        get => !Player.SessionVariables.ContainsKey(API.API.SelectedObjectSessionVarName);
    }
