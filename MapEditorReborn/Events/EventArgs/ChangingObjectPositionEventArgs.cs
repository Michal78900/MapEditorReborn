// -----------------------------------------------------------------------
// <copyright file="ChangingObjectPositionEventArgs.cs" company="MapEditorReborn">
...
public class ChangingObjectPositionEventArgs : EventArgs
{
    ...
    /// <summary>
    /// Gets the <see cref="PluginAPI.Core.Player"/> who's spawned the <see cref="MapEditorObject"/>.
    /// </summary>
